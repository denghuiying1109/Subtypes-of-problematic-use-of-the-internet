...
write.csv(Executive_function, file = "/Processed data/Merged_Executive_function.csv")


############################### Negative affect ###############################

#The Positive and Negative Affect Schedule
PANAS<-read.csv("/Raw data/Negative emotion/PANAS.csv")
PANAS<-dplyr::select(PANAS,EID,PANAS_NegativeAffect)

#Mood & Feelings Questionnaire
MFQ_SR<-read.csv("/Raw data/Negative emotion/MFQ_SR.csv")
MFQ_SR<-dplyr::select(MFQ_SR, EID, MFQ_SR_Total)

#CBCL
CBCL<-read.csv("/Raw data/Negative emotion/CBCL.csv")
...
CBCL_Pre<-read.csv("/Raw data/Negative emotion/CBCL_Pre.csv")
...
CBCL_com<-rbind(CBCL,CBCL_Pre)

#SDQ
SDQ<-read.csv("/Raw data/Negative emotion/SDQ.csv")
...
#.................Merge files.................................
Negative_affect<-merge(ID,CBCL_com,by=c("EID"), all.x=TRUE)
Negative_affect<-merge(Negative_affect,ARI_SR,by=c("EID"), all.x=TRUE)
Negative_affect<-merge(Negative_affect,MFQ_SR,by=c("EID"), all.x=TRUE)
Negative_affect<-merge(Negative_affect,PANAS,by=c("EID"), all.x=TRUE)
Negative_affect<-merge(Negative_affect,SDQ,by=c("EID"), all.x=TRUE)

write.csv(Negative_affect, file = "/Processed data/Merged_Negative_emotion.csv")
